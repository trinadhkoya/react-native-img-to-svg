            ...
            <Svg viewBox={viewBox} height={height} width={width} fill={fill}>
                ...
                <G id="Layer_2" data-name="Layer 2">
                    <G id="Layer_1-2" data-name="Layer 1">
                        <Polygon className="cls-1" points="52.62 7.48 58.21 3.65 63.79 6.01 52.62 11.26 52.62 7.48" fill='#f48990'/>
                        <Polygon className="cls-2" points="52.21 35.08 43.5 28.54 53.04 22.83 61.75 29.38 52.21 35.08" fill='#f48990' />
                        ...
                        <Path className="cls-3" d="M52.62,30a1,1,0,0,1-1-1V5.52a1,1,0,0,1,2,0V29A1,1,0,0,1,52.62,30Z" fill={fill}/>
                    </G>
                </G>
            </Svg>
