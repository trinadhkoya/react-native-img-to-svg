...
class GiftCardIco extends React.Component {
    constructor(props) {
        super(props);
    }
    ...
    render() {
        ...
        return (
            <Svg viewBox={viewBox} height={height} width={width}>
                ...
                <G  >
                    <G fill={fill}>
                        <Rect fill={'#fff'} y="7.65" width="51.75" height="30.21" />
                        <Path
                        ...
                        <Path  d="M50.81,16H.94a.93.93,0,1,1,0-1.85H50.81a.93.93,0,1,1,0,1.85Z"/>
                        <Path
